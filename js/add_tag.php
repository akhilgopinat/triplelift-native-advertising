...
function triplelift_np_admin_add_tag(target_div) {
    jQuery("#"+target_div).html(
        '<ul class="card-list">'+
            '<li><a href="#" id="triplelift_np_admin_sent_html"><strong>Tag</strong><br>&nbsp;<br><span class="card-list-text">TripleLift sent me a tag</span></a></li>'+
            '<li><a href="#" id="triplelift_np_admin_theme_placement"><strong>Theme</strong><br>&nbsp;<br><span class="card-list-text">Plugin will make appropriate placement for my theme</span></a></li>'+
            '<li><a href="#" id="triplelift_np_admin_existing_placement"><strong>Advanced</strong><br>&nbsp;<br><span class="card-list-text">Use existing placement</span></a></li></ul>');
