...
<p>Modify the settings for your tag below:</p>

<div id="triplelift_np_admin_modify_tag">
	<form name="modify_placement" method="post" action="<?php print TRIPLELIFT_NP_BASE_URL;?>">
		...
		<p>Script tag:<br><textarea rows="3" cols="75" id="triplelift_np_admin_script_html" name="triplelift_np_admin_script_html"><?php print str_replace('/textarea', '', stripslashes($this->tag_settings['script'])); ?></textarea></p>
		...
		<p><input type="submit" name="Submit" class="button-primary" value="<?php esc_attr_e('Submit') ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="triplelift_np_admin_confirmation" href="<?php print TRIPLELIFT_NP_BASE_URL.'&tab=modify_tag&'.$this->action_field.'=delete_tag&tag='.urlencode($this->tag_settings['script']);?>">Delete</a></p>
